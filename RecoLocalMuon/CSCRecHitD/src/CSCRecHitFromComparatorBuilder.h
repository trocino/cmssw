#ifndef CSCRecHitD_CSCRecHitFromComparatorBuilder_h 
#define CSCRecHitD_CSCRecHitFromComparatorBuilder_h 
...
class CSCRecHitFromComparatorBuilder
{
 public:
   ...
   */
  explicit CSCRecHitFromComparatorBuilder( const edm::ParameterSet& ps);
  
  ~CSCRecHitFromComparatorBuilder();
  ...
  void build( const CSCComparatorDigiCollection* stripds, const CSCWireDigiCollection* wireds,
 ...
 private:
   ...
   */
  CSCHitFromComparatorOnly* hitsFromComparatorOnly_;
